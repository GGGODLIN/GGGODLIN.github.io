...
voice: v3-threads-line-cc-bolas（加結構化小標變體）
status: 實驗 draft（v3 內容不動，僅補分段小標）
...
marketplace 清乾淨不等於你的電腦也清乾淨，這是兩件事。如果你也長期裝著一堆 VS Code extension，不用一開始就排成每天跑，先掃一次，把這種沒人會注意到的孤兒版本清掉再說。
